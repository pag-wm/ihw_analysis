...
DATASETS = {
    "shipping": ("yuba-pjk3", "report_year = '2024'"), 
    "contacts": ("azdq-v4ap", None), # Fetch all contacts
    "annual_waste_summary": ("79s2-9ack", "date_extract_y(report_year) = 2024"), # Using date_extract_y for floating timestamp
    "nor_facilities": (
        "v287-9kbw", 
        "site_county_name IN ('HARRIS', 'JEFFERSON', 'DALLAS', 'NUECES') AND status_code_desc = 'ACTIVE'"
    ), # Limit focus regions and active sites for massive speedups
